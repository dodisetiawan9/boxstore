...
<head>
  ...
  <title>BoxStore | Dashboard</title>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backEnd/dist/css/dropzone.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/backEnd/dist/css/basic.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>BX</b>S</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>BOX</b>Store</span>
    </a>
                ...
                <div class="row">
                 <!--  <div class="col-xs-4 text-center">
                  ...
                  <div class="col-xs-6 col-xs-offset-3 text-center">
                    <a href="<?= base_url(); ?>admin/edit_password">Ubah Password</a>
                  </div>
                 <!--  <div class="col-xs-4 text-center">
                    <a href="#">Log out</a>
                  </div> -->
  ...
  <div class="content-wrapper content-fix">
    <?php echo $content; ?>
  </div>
  <!-- /.content-wrapper -->
